...
class Course_registration extends BaseModel{
    function getAll($id){
        ...
        $sql="SELECT course_registration.*, courses.id AS coursesId, courses.name AS coursesName, courses.thumbnail AS coursesImg, courses.instructor_id AS coursesIn, courses.description AS 	coursesDes, courses.price,courses.address AS coursesAddress,
