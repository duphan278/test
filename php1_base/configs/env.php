...
define('BASE_URL',          'http://localhost/DUAN/php1_base/'); // Thêm đường dẫn tới thư mục dự án

define('BASE_URL_ADMIN',          'http://localhost/DUAN/php1_base/?mode=admin'); // Thêm đường dẫn tới thư mục dự án
